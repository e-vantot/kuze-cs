...
namespace INFT3050.PaymentSystem
{
    ...
    public class INFT3050PaymentSystem : IPaymentSystem
    {
        ...
        private DummyPaymentAccount[] m_dummyAccounts = new DummyPaymentAccount[] {
            new DummyPaymentAccount("arthur anderson", "4444333322221111",100000, new DateTime(2025, 11, 1), 123, TransactionResult.Approved),
            new DummyPaymentAccount("betty boo", "5105105105105100", 2000, new DateTime(2025, 05, 1), 123, TransactionResult.Approved),
            new DummyPaymentAccount("carol carver", "2223000048400011", 300, new DateTime(2025, 09, 1), 123, TransactionResult.Approved),
            new DummyPaymentAccount("don desilva","2223520043560014", 40, new DateTime(2025, 11, 1), 123, TransactionResult.Approved),
            new DummyPaymentAccount("emma edwards","378282246310005", 500, new DateTime(2025, 11, 1), 123, TransactionResult.Declined),
            new DummyPaymentAccount("timmy timeout","38520000023237", 500, new DateTime(2025, 11, 1), 123, TransactionResult.ConnectionFailure)
        };
    }
